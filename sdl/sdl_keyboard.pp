...
{$INCLUDE begin_code.inc}
 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
  Type
     ...
     BoolArray  = Array[0..322] of Boolean;
  ...
  function SDL_EnableKeyRepeat(keydelay, keytinterval: longint): longint; cdecl;
  ...
  function SDL_EnableKeyRepeat(keydelay, keytinterval: longint): longint; cdecl; external 'SDL';
